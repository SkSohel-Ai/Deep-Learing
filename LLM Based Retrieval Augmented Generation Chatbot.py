...
db = SQLDatabase.from_uri(mysql_uri, include_tables=['house_price_dataset'], sample_rows_in_table_info=2)
...
def generate(query: str, db_context: str) -> str:
    ...
    Guideline:
    1.Treat id column as the primary key column.
    2.Don't provide only id of the house in the response to the user instead provide id with neighborhood.  
